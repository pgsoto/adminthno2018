<div class="col-sm-10 text-left marg-fix">
  	...
  	<div class="subtitulo-btn">
    	<h2>&nbsp;</h2>
        <a class="btn btn-default" href="/portada/somos-tv/agregar/">Agregar</a>
    </div>
            ...
            <?php if($result){ ?>
                <?php foreach($result as $aux){ ?>
                    <tr> 
                        ...
                        <td><?php echo $aux->bajada; ?></td>
                        <td><?php echo $aux->fecha_publicacion; ?></td>
                        <td><?php echo ($aux->estado)?'Activo':'Inactivo'; ?></td>
						<td class="text-center">
                            <a href="/portada/somos-tv/editar/<?php echo $aux->codigo; ?>/"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                        </td>
                        <td class="text-center">
