    ...
    <form action="#" method="post" id="form-agregar" >
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
        	<div class="col-md-5">
                ...
                <label>Bajada</label>
                <textarea class="form-control" rows="3"  id="bajada" name="bajada"><?= isset($result->bajada) ? $result->bajada : ''; ?></textarea>
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/portada/slider-turismo/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/portada/slider-turismo/eliminar-imagen/';
    var urlCargar = '/portada/slider-turismo/cargar-imagen/';
    var urlCortar = '/portada/slider-turismo/cortar-imagen/';
    var galeria = false;
