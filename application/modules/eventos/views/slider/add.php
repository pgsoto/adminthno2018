        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<a href="/eventos/slider/" class="btn btn-can">Cancelar</a>
...
<script>
	...
	var id = 1;
	var urlDelete = '/eventos/slider/eliminar-imagen/';
    var urlCargar = '/eventos/slider/cargar-imagen/';
    var urlCortar = '/eventos/slider/cortar-imagen/';
    var galeria = false;
