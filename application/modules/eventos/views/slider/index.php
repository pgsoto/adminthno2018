<div class="col-sm-10 text-left marg-fix">
  	...
  	<div class="subtitulo-btn">
    	<h2>&nbsp;</h2>
        <a class="btn btn-default" href="/eventos/slider/agregar/">Agregar</a>
    </div>
                ...
                <?php foreach($result as $aux){ ?>
                    <tr> 
						...
						<td class="text-center">
                            <a href="/eventos/slider/editar/<?php echo $aux->codigo; ?>/"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                        </td>
                        <td class="text-center">
