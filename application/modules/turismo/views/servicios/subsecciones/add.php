        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
            ...
            <div class="col-xs-12">
                <div class="text-left" style="margin-top:20px;">
                    <a href="/turismo/servicios/subsecciones/<?= $seccion; ?>/" class="btn btn-can">Cancelar</a>
...
<script>
    ...
    var id = 1;
    var urlDelete = '/turismo/servicios/subsecciones/eliminar-imagen/';
    var urlCargar = '/turismo/servicios/subsecciones/cargar-imagen/';
    var urlCortar = '/turismo/servicios/subsecciones/cortar-imagen/';
    var galeria = true;
