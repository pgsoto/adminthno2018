    ...
    <form action="#" method="post" id="form-agregar" >
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
        	<div class="col-md-5">
                ...
                <label>Cómo llegar en Automóvil</label>
                <textarea class="form-control" rows="3" id="como_llegar_en_automovil"
                          name="como_llegar_en_automovil"><?= isset($result->como_llegar_en_automovil) ? $result->como_llegar_en_automovil : ''; ?></textarea>

                <label>Cómo llegar en Tren</label>
                <textarea class="form-control" rows="3" id="como_llegar_en_tren"
                          name="como_llegar_en_tren"><?= isset($result->como_llegar_en_tren) ? $result->como_llegar_en_tren : ''; ?></textarea>

                <label>Cómo llegar en Bus</label>
                <textarea class="form-control" rows="3" id="como_llegar_en_bus"
                          name="como_llegar_en_bus"><?= isset($result->como_llegar_en_bus) ? $result->como_llegar_en_bus : ''; ?></textarea>

                <label>Cómo llegar en Avión</label>
                <textarea class="form-control" rows="3" id="como_llegar_en_avion"
                          name="como_llegar_en_avion"><?= isset($result->como_llegar_en_avion) ? $result->como_llegar_en_avion : ''; ?></textarea>
...
<script>
	...
	var id = 1;
	var urlDelete = '/turismo/donde-queda/eliminar-imagen/';
    var urlCargar = '/turismo/donde-queda/cargar-imagen/';
    var urlCortar = '/turismo/donde-queda/cortar-imagen/';
    var galeria = true;
