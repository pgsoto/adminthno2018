        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
			...
			<div class="col-xs-12">
				<div class="text-left" style="margin-top:20px;">
					<!--<a href="/municipio/organigrama/" class="btn btn-can">Cancelar</a>-->
...
<script>
	...
	var id = 1;
	var urlDelete = '/municipio/organigrama/eliminar-imagen/';
    var urlCargar = '/municipio/organigrama/cargar-imagen/';
    var urlCortar = '/municipio/organigrama/cortar-imagen/';
    var galeria = true;
