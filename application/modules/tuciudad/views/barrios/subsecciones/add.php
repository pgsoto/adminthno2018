        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
            ...
            <div class="col-xs-12">
                <div class="text-left" style="margin-top:20px;">
                    <a href="/tuciudad/seguridad/subsecciones/<?= $seccion; ?>/" class="btn btn-can">Cancelar</a>
...
<script>
    ...
    var id = 1;
    var urlDelete = '/tuciudad/seguridad/subsecciones/eliminar-imagen/';
    var urlCargar = '/tuciudad/seguridad/subsecciones/cargar-imagen/';
    var urlCortar = '/tuciudad/seguridad/subsecciones/cortar-imagen/';
    var galeria = true;
