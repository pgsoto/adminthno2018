        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
            ...
            <div class="col-xs-12">
                <div class="text-left" style="margin-top:20px;">
                    <a href="/tuciudad/talcahuano-historico/subsecciones/<?= $seccion; ?>/" class="btn btn-can">Cancelar</a>
...
<script>
    ...
    var id = 1;
    var urlDelete = '/tuciudad/talcahuano-historico/subsecciones/eliminar-imagen/';
    var urlCargar = '/tuciudad/talcahuano-historico/subsecciones/cargar-imagen/';
    var urlCortar = '/tuciudad/talcahuano-historico/subsecciones/cortar-imagen/';
    var galeria = true;
