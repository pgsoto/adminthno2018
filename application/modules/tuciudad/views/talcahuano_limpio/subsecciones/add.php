        ...
        <div class="row" style="margin-top:30px; margin-bottom:30px;">
            ...
            <div class="col-xs-12">
                <div class="text-left" style="margin-top:20px;">
                    <a href="/tuciudad/talcahuano-limpio/subsecciones/<?= $seccion; ?>/" class="btn btn-can">Cancelar</a>
...
<script>
    ...
    var id = 1;
    var urlDelete = '/tuciudad/talcahuano-limpio/subsecciones/eliminar-imagen/';
    var urlCargar = '/tuciudad/talcahuano-limpio/subsecciones/cargar-imagen/';
    var urlCortar = '/tuciudad/talcahuano-limpio/subsecciones/cortar-imagen/';
    var galeria = true;
