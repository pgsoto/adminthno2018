...
class Subsecciones_talcahuano_historico extends CI_Controller
{
    ...
    public function index()
    {
        ...
        #Nav
        $this->layout->nav(array('Desarrollo Productivo' => '/tuciudad/talcahuano-historico/', $this->nombre => '/'));
    ...
    public function agregar($seccion = false, $codigo = false)
    {
        ...
        if (isset($result)) {
            ...
            $this->layout->nav(array("Desarrollo Productivo" => "/tuciudad/talcahuano-historico/", $this->nombre => "/tuciudad/talcahuano-historico/subsecciones/" . $seccion->codigo . "/", "Editar " . $result->nombre => "/"));
        } else {
            $data['titulo'] = 'Agregar ' . $this->nombre;
            $this->layout->title('Agregar ' . $this->nombre);
            $this->layout->nav(array("Desarrollo Productivo" => "/tuciudad/talcahuano-historico/", $this->nombre => "/tuciudad/talcahuano-historico/subsecciones/" . $seccion->codigo . "/", "Agregar " . $this->nombre => "/"));
        }
